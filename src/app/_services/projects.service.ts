...
export class ProjectsService {
  ...
  projects: Project[] = [
    {id: 0, name: "Portfolio Website", pictures: ["../../assets/portfoliositepics/portfoliositepic1.JPG", "../../assets/portfoliositepics/portfoliositepic2.JPG", "../../assets/portfoliositepics/portfoliositepic3.JPG"], projectLink: "//www.github.com", summary: "A one page dynamic webapp built using Angular and Node.JS to showcase my professional experience.", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", tags: [Tag.ANGULAR, Tag.BOOTSTRAP, Tag.NODEJS, Tag.TYPESCRIPT]},
